-- NotingHill Database Schema v1.0
-- SQLite + FTS5
...
-- ============================================================
-- 3. item_content — extracted text (separated to avoid bloat)
-- ============================================================
...
-- ============================================================
-- 4. item_metadata — structured metadata per file type
-- ============================================================
...
-- ============================================================
-- 5. item_fts — full-text search virtual table
-- ============================================================
...
CREATE INDEX IF NOT EXISTS idx_dup_group_items_group ON duplicate_group_items(group_id);
CREATE INDEX IF NOT EXISTS idx_dup_group_items_item  ON duplicate_group_items(item_id);
...
CREATE TABLE IF NOT EXISTS timeline_events (
  ...
  event_date_ts INTEGER NOT NULL,
  event_label   TEXT,
  event_type    TEXT,
  confidence    REAL,
  created_ts    INTEGER NOT NULL,
...
CREATE INDEX IF NOT EXISTS idx_timeline_events_date ON timeline_events(event_date_ts);

-- ============================================================
-- 9. timeline_event_items
-- ============================================================
